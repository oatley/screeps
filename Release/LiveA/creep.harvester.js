...
var creepHarvester = {
    ...
    work: function (creep) {
        ...
        if (creep.room.energyAvailable == 0) {
            ...
            } else if (!closestHostile && targetStorage.store.energy < targetStorage.storeCapacity && !creep.memory.building && !creep.memory.upgrading && creep.room.controller.ticksToDowngrade >= 5000) {
